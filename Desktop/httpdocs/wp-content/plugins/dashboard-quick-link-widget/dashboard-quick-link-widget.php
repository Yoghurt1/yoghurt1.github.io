		...
		<div class="dashboard_quick_link_container">
			...
			<form method="post" action="options.php">
				...
				<table class="form-table quick_dashboard_link_form">
					...
					<th scope="row"></th>
					<td>
						If you got any feedback regarding the plugin, please let me know via developer@hemthapa.com or <a href="http://hemthapa.com?ref=<?php echo $_SERVER['HTTP_HOST']; ?>" target="_blank">hemthapa.com</a> 
					</td>
					</tr>
