...
jQuery(\'.sp_change_indicator\').html(\'<img src="' . SP_CDM_PLUGIN_URL . 'images/loading.gif"> ' . __("Please wait, your file is currently uploading", "sp-cdm") . 'Please wait, your file is currently uploading! </em>\');
...
';
  if (get_option('sp_cu_user_disable_search') == 1) {
			...
			$html .= '<div style="text-align:right;padding:10px'.$hide_search.'"><input   type="text" name="search" id="search_files"><a href="#" class="sp-cdm-search-button cdm_button">' . __("Search", "sp-cdm") . '</a></div>';
