...
add_action('admin_init', array($sp_cdm_local_import,'admin_js'));
add_action('admin_menu',  array($sp_cdm_local_import,'admin_css'));
...
add_action('wp_head',  array($sp_cdm_local_import,'css'));

add_action('admin_enqueue_scripts', array($sp_cdm_local_import,'js'));
add_action('admin_head',  array($sp_cdm_local_import,'css'));
